...
import { faTimesCircle, faSortDown, faChevronLeft as Back } from "@fortawesome/free-solid-svg-icons"
...
CandidateEditProfilePage.getLayout = (page) => <CandidateLayout title="Pumpt | Home">{page}</CandidateLayout>
