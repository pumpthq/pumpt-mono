        ...
        <div className="parent">
          ...
          <div className="div4 match-table">
            <div className="match-table-head">
              <span className="candidate-name"><strong>Candidate</strong></span>
              ...
              {matchesState?.map(match => {
                return (
                  <div className="match-table-row">
                    <span className="candidate-name"><strong>{`${match.candidate.firstName} ${match.candidate.lastName}`}</strong></span>
