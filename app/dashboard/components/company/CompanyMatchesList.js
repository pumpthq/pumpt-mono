...
import Match from './CompanyMatch'
import CandidateMatchSkeleton from './CompanyMatchSkeleton'

const CompanyMatchesList = ({ matches, selectedTab }) => {
...
export default CompanyMatchesList