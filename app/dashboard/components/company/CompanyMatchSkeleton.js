...
const CompanyMatchSkeleton = ({ match }) => {
  // console.log(match)
    ...
    <>
      <div className="match">
        ...
        <div className="match-heading">
          ...
          {/* <FontAwesomeIcon style={{ marginRight: '10px' }} icon={Company} /><Skeleton width={150} />
          <FontAwesomeIcon style={{ marginRight: '10px' }} icon={Location} /><Skeleton width={150} /> */}
        </div>
...
export default CompanyMatchSkeleton